                  ...
                  child: Wrap(
                    children: [
                      ...
                      ItemStatus(
                          ...
                          onPress: () {
                            if (isSelect != 1) {
                              context.read<DetailTaskBloc>().add(OnGetData(status: "pending"));
                              setState(() {
                                isSelect = 1;
                              });
                            }
                      ...
                      ItemStatus(
                          ...
                          onPress: () {
                            if (isSelect != 2) {
                              context.read<DetailTaskBloc>().add(OnGetData(status: "process"));
                              setState(() {
                                isSelect = 2;
                              });
                            }
                      ...
                      ItemStatus(
                          ...
                          onPress: () {
                            if (isSelect != 3) {
                              context.read<DetailTaskBloc>().add(OnGetData(status: "done"));
                              setState(() {
                                isSelect = 3;
                              });
                            }
                      ...
                      ItemStatus(
                          ...
                          isSelect: isSelect == 4,
                          onPress: () {
                            context.read<DetailTaskBloc>().add(OnGetData(status: "late"));
                            if (isSelect != 4) {
                              setState(() {
                                isSelect = 4;
                              });
